...
<div class="custom-body">
    <div class="custom-container">
        <div class="layui-card">
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/question/saveShorter.do" method="post">
                ...
                <!--简答题的答案编辑框 start-->
                <div class="layui-card-body">
                    <div class="custom-upload-question-title">答案</div>
                    <textarea class="layui-textarea" name="answer"></textarea>
                </div>
                <!--简答题的答案编辑框 end-->
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn custom-upload-question-btn" lay-submit lay-filter="uploadShorter">保存题目</button>
...
<script>
    ...
    layui.use(['element','form', 'upload'], function () {
        ...
        form.on('submit(uploadShorter)', function (data) {
