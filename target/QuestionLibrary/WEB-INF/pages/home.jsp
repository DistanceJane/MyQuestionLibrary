                            ...
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <div class="custom-img">
                                        <img src="../../images/library.png" class="custom-home-img" alt="试题库">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-col-md3">
                        <div class="custom-panel">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <div class="custom-img">
                                        <img src="../../images/wrognlib.png" class="custom-home-img" alt="错题集">
                                    </div>
                    ...
                    <div class="layui-col-md3">
                        <div class="custom-panel">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <div class="custom-img">
                                        <img src="../../images/notes.png" class="custom-home-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-col-md3">
                        <div class="custom-panel">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <div class="custom-img">
                                        <img src="../../images/honor.png" class="custom-home-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="custom-panel">
                        <div class="layui-card">
                            ...
                            <div class="layui-card-body">
                                <div class="layui-row">
                                    <div class="custom-img">
                                        <img src="../../images/you.jpg" class="custom-home-photo img-circle">
                                    </div>
                                </div>
                                <div class="layui-row">
                                    <div class="custom-horizon-box">
                                        <div class="custom-horizon-center">
                                            <span class="custom-home-username"><strong>${sessionScope.user.username}</strong></span><img
                                                src="../../images/boy.png" class="custom-home-gender">
                                        </div>
                                    </div>
                                </div>
                                <div class="layui-row">
